...
public class Shapes 
{
    ...
    void create() 
    {
        ...
        for (int i = 0; i < sqrCount; i++) 
        {
            ...
            int color = main.color(255); 

            float xVel = main.random(-2, 2); 
            float yVel = main.random(-2, 2);

            squares.add(new Square(x, y, squareSize, main, color, xVel, yVel)); 
        }
        ...
        for (int i = 0; i < triCount; i++) 
        {
            ...
            triangles.add(new Triangle(x, y, triangleSize, main, color, xVel, yVel)); 
        }
    }
    ...
    //         if (circle.isClicked(main.mouseX, main.mouseY)) 
    //         {
    //             circle.mouseClickedBehavior(); // Call specific behavior for Circle
    //             break;
    //         }
    //     }
